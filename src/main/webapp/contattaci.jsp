...
<body>
        ...
        <h1 align="center"><b>Chi siamo</b></h1>
        <br>
        <div id="infotext">
            Su questa piattaforma potete visualizzare un elenco di ospedali e strutture sanitarie aderenti
            alla rete, consultare le prestazioni erogate nelle varie strutture, i medici abilitati e prenotare
            visite mediche e prestazioni specialistiche. <br>
            Il tutto a portata di click! Insomma, una vera e propria rivoluzione nel mondo della Sanità pubblica locale!
            <br>
            Siamo a tua dispozione per qualsiasi dubbio, quindi non esitare a contattarci!
        </div>
        <br>
            ...
            <div class="row">
                ...
                <div class="col-6">
                    <form class="form">
                        ...
                        <div class="col-20">
                            <label for="InputMail"><b>E-mail</b></label>
...
>>>>>>> branch 'master' of https://github.com/egalli64/black367.git
</html>