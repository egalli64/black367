...
<body>
	...
	<h2>
		I medici che lavorano nelle strutture con noi convenzionate sono professionisti di grande
		esperienza. Di seguito potrà trovare le informazioni relative ai nostri medici, suddivisi per
		reparto di appartenenza: <b><a href="#cardio">cardiologia</a>, <a href="#generale">chirugia
				generale</a>, <a href="#vasco">chirurgia vascolare</a>, <a href="#dermato">dermatologia</a>, <a
			href="#endo">endocrinologia</a>, <a href="#gastro">gastroenterologia</a>, <a href="#gineco">ginecologia
				e ostetricia</a>, <a href="#ocu">oculistica</a>, <a href="#orto">ortopedia</a>, <a href="#pneumo">pneumologia</a>,
			<a href="#psich">psichiatria</a>, <a href="#radio">radiologia</a> e <a href="#reumo">reumatologia</a>.</b>
	</h2>
	<div class="reparto">
		<h4 id="cardio">
			<b>Cardiologia</b>
